...
export class Contract {
    ...
    this.circuits = {
      submitProof: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(hash_0).concat(_descriptor_0.toValue(commitment_0).concat(_descriptor_1.toValue(timestamp_0))),
      ...
      verifyProof: (...args_1) => {
        ...
        const result_0 = this._verifyProof_0(context, partialProofData, hash_0);
  ...
  _submitProof_0(context, partialProofData, hash_0, commitment_0, timestamp_0) {
    __compactRuntime.assert(!_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            'A proof for this hash already exists');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
  ...
  _verifyProof_0(context, partialProofData, hash_0) {
